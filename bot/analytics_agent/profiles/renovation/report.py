...
def build_renovation_report(task_id: str, params: Dict[str, Any]) -> str:
    ...
    out = [
        "🧠 Черновая оценка базовых материалов отделки",
        "",
        f"ID: {task_id}",
        f"Тип: {type_title}",
        f"Площадь: {area:g} м²",
        ...
        "",
        "Что входит в текущий расчёт:",
        "• напольное покрытие;",
        "• плитка санузла;",
        "• грунтовка;",
        "• шпаклёвка;",
        "• базовая отделка стен (краска или обои);",
        "• ровнитель / черновые смеси.",
        "",
        "Что НЕ входит:",
        "• двери и фурнитура;",
        "• сантехника, трубы, приборы;",
        "• электрика, кабель, розетки, щит;",
        "• кухня, мебель, техника, свет;",
        "• доставка, подъём, вывоз мусора;",
        "• демонтаж.",
        "",
        "Статус: материалы считаются по локальному снимку рынка ВсеИнструменты.",
        "Цены ориентировочные, по последнему сохранённому снимку рынка.",
        "",
    ...
    if labor:
        ...
        out.extend([
            ...
            "",
            "Статус: работы считаются по локальному снимку рынка Profi.ru.",
            "Ставки ориентировочные, по последнему сохранённому labor_cache.json.",
            "",
            "Материалы + работы:",
