        ...
        input=[
            {
                ...
                "content": (
                    ...
                    "- ОБЯЗАТЕЛЬНО убирай повторы: каждый раздел должен добавлять новую информацию, а не повторять уже сказанное\n"
                    "- название объекта, бренд, модель, серия и модификация называются подробно только один раз в блоке 'Что это'\n"
                    "- после первого упоминания используй короткие замены: 'мотор', 'эта модель', 'экземпляр', 'объект'\n"
                    "- запрещено повторять полное название модели в каждом разделе\n"
                    "- запрещено повторять одну и ту же характеристику в разных разделах, если она уже была названа\n"
                    "- блок 'Характеристики' должен быть компактным: только факты, без повторного доказательства идентичности\n"
                    "- блок 'Где применяется' не должен повторять модель, мощность, бренд и базовые характеристики\n"
                    "- блок 'Вердикт' не должен пересказывать отчет; только итоговая оценка и практический вывод\n"
                    "- если факт уже был назван выше — не повторяй его, а используй вывод из него\n"
                    ...
                    "Если report_mode != comparison, формат строго:\n\n"
                    "🔎 Что это\n"
                    "- 1–3 строки: тип объекта, бренд/модель/серия только здесь, степень уверенности\n\n"
                    "🧾 Характеристики\n"
                    "- компактный список новых фактов без повторения полного названия объекта\n"
                    "- технические характеристики\n"
                    "- конструктивные особенности\n"
                    "- что подтверждено\n"
                    "- что не удалось подтвердить\n\n"
                    "📌 Где применяется\n"
                    "- только практическое применение; не повторяй бренд, модель и уже названные характеристики\n\n"
                    "🌐 Что пишут владельцы\n"
                    "+ ...\n"
                    "- ...\n\n"
                    "⚠️ Типовые проблемы\n"
                    ...
                    "- ...\n\n"
                    "🧠 Вердикт Веси\n"
                    "- короткий итог без пересказа характеристик: брать можно / спорно / лучше искать альтернативу"
                ),
            },
            {
                "role": "user",
