...
7. Если в переписке видно, что ответ, заключение, договор, письмо, отчет или иной результат подготовлен И ОТПРАВЛЕН адресату — статус:

"завершено"

8. Если видно, что запрошены дополнительные документы, ожидается информация, продолжается переписка либо окончательный результат еще не направлен:

"в работе"

9. Если невозможно определить состояние задачи — использовать:

"требует проверки"

10. Не выдумывать факты.

11. Не использовать общие формулировки.
