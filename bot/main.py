...
async def vesya_handler(message: Message) -> None:
    ...
    if re.search(
        r"\b(покажи функции|что умеешь|твои функции|список функций|меню|help|подробнее)\b",
        text,
        flags=re.I,
    ):
        await _answer_long(
            ...
            (
                ...
                "1. Переводчик\n"
                "   Пример: Веся включи переводчика с русского на английский\n\n"
                ...
                "4. Поиск клипов YouTube\n"
                "   Пример: Веся дай что-нибудь из Offspring\n\n"

                "5. Поиск фото\n"
                "   Пример: Веся дай фото озера Байкал\n\n"

                "6. Аналитика\n"
                "   Пример: Веся включи аналитика\n\n"

                "7. Работа с документами\n"
                "   Просто пришли документ, PDF, Word, Excel, фото или скриншот и задай вопрос\n\n"

                "8. Обычный диалог\n"
                "   Просто общайся со мной обычным языком"
            ),
        )
        return
