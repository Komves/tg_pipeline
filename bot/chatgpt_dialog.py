            ...
            input=[
                {
                    ...
                    "content": (
                        ...
                        "- Сначала дай позицию Веси: нормально / мутно / цинично / показательно / пахнет пиаром / технически логично, но морально скользко.\n"
                        "- Можно упомянуть максимум одну ключевую деталь объекта как опору для мнения.\n"
