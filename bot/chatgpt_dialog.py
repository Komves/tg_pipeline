...
def semantic_context_route(
    ...
    *,
    ...
    try:
            ...
            input=[
                {
                    ...
                    "content": (
                        ...
                        "Верни только JSON:\n"
                        "{\"route\":\"chat|object_analysis|topic_followup|calendar\",\"instruction\":\"обязательный контракт для исполнителя: что сделать, какой тип ответа, чего не делать\"}"
                    ),
                },
                {
                    "role": "user",
        ...
        if route not in {"chat", "object_analysis", "topic_followup", "calendar"}:
            route = "chat"
