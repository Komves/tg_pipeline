    ...
    try:
        ...
        content = [{
            ...
            "text": (
                ...
                "Если пользователь спрашивает про музыку, а транскрибация не дала названия трека — честно скажи, что песню не распознала, но можешь оценить настроение звука.\n"
                "Формат: 1–3 короткие фразы. По-русски. Без вопросов пользователю."
            ),
        }]
        ...
        if any(w in reply.lower() for w in bad_video_words):
            reply = "Море, поза и демонстрация кормы. Музыку не опознала — звучит как ретро-гламур."
