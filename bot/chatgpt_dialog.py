...
def _conversation_reply(
    ...
    system = (
        ...
        "Если пользователь коротко отвечает на бытовую реплику, напоминание или шутит в ответ — отвечай одной короткой фразой.\n"
        "Не разворачивай мини-анализ, не объясняй шутку, не описывай стиль реплики.\n"
        "Для коротких бытовых ответов формат: 1 фраза, максимум 15 слов.\n"
    )
